...
function doubleValues(arr) {
    //This will be a foreach function.a
...
*/
//Accepts an array of strings and returns a new array with only the first and last characters of each string
...
function vowelCount(str) {
    //create an array that includes the a e i o u vowles
    let stringspit = str.split("");
    let vowls = "aeiou";
    let object = {};
    stringsplit.foreach(function (letter) {
        let lowerCaseLetter = letter.toLowerCase()
        if (vowls.indexOf(lowerCasedLetter) !== -1) {
...
function find(arr, searchValue) {
    return arr.filter(function (value) {
        return arr[searchValue] === undefined;
    })[0];
}
